<script lang="ts">
    ...
    export let selectedCourses: Writable<string[]>;
        ...
        <div class="course">
            ...
            <button class="add" on:click={()=>{
                if ($selectedCourses.includes(course.code)) {
                    selectedCourses.update((courses) => courses.filter((c) => c != course.code));
                } else {
                    selectedCourses.update((courses) => [...courses, course.code]);
                }
            }}>{
